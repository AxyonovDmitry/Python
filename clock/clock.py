...
clock60 = dict(zip(range(60), range(0, 360, 6)))  # для часов, минут и секунд
...
while True:
    ...
    # draw clock
    pygame.draw.line(surface, pygame.Color('magenta'), (H_WIDTH, H_HEIGHT), get_clock_pos(clock60, hour, 'hour'), 15)
    pygame.draw.line(surface, pygame.Color('cyan'), (H_WIDTH, H_HEIGHT), get_clock_pos(clock60, minute, 'min'), 7)
    ...
    # digital clock
    time_render = font.render(f'{t:%H:%M:%S}', True, pygame.Color('black'), pygame.Color('magenta'))
